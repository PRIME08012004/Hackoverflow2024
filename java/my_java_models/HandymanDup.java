...
public class HandymanDup {
	
	public boolean Entry(HandyMan handyman) throws ClassNotFoundException{
		...
		try {
			...
			java.sql.PreparedStatement ps = connection.prepareStatement("SELECT * FROM handyman WHERE Name = ?;");
